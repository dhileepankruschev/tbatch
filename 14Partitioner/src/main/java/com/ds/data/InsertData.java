...
//				String insertTableSQL = "INSERT INTO USERS (ID, USER_LOGIN, USER_PASS, AGE) VALUES (':id',':name',':pass',':age')";
				String insertTableSQL = "INSERT INTO USERS (USER_LOGIN, USER_PASS, AGE) VALUES (':name',':pass',':age')";
...
//				insertTableSQL = insertTableSQL.replaceAll(":id", String.valueOf(i));
				...
				insertTableSQL = insertTableSQL.replaceAll(":age", String.valueOf(generator.nextInt(50)+20));
